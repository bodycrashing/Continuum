...
S_zero_one = zero_mm_one(:,2); %strain
F_zero_one = zero_mm_one(:,4); %force

load zero_mm_two.txt
S_zero_two = zero_mm_two(:,2); %strain
F_zero_two = zero_mm_two(:,4); %force

load zero_mm_three.txt
S_zero_three = zero_mm_three(:,2); %strain
F_zero_three = zero_mm_three(:,4); %force

%Average data for zero mm holes elements
S_zero_ava = (S_zero_one+S_zero_two+S_zero_three)/3; %average strain
F_zero_ava = (F_zero_one+F_zero_two+F_zero_three)/3; %average force

%% five mm hole element
load five_mm_one.txt
S_five_one = five_mm_one(:,2); %strain
F_five_one = five_mm_one(:,4); %force

load five_mm_two.txt
S_five_two = five_mm_two(:,2); %strain
F_five_two = five_mm_two(:,4); %force

load five_mm_three.txt
S_five_three = five_mm_three(:,2); %strain
F_five_three = five_mm_three(:,4); %force

%Average data for five mm holes elements
S_five_ava = (S_five_one+S_five_two+S_five_three)/3; %average strain
F_five_ava = (F_five_one+F_five_two+F_five_three)/3; %average force

%% six mm hole element
load six_mm_one.txt
S_six_one = six_mm_one(:,2); %strain
F_six_one = six_mm_one(:,4); %force

load six_mm_two.txt
S_six_two = six_mm_two(:,2); %strain
F_six_two = six_mm_two(:,4); %force

load six_mm_three.txt
S_six_three = six_mm_three(:,2); %strain
F_six_three = six_mm_three(:,4); %force

%Average data for six mm holes elements
S_six_ava = (S_six_one+S_six_two+S_six_three)/3; %average strain
F_six_ava = (F_six_one+F_six_two+F_six_three)/3; %average force

%% seven mm hole element
load seven_mm_one.txt
S_seven_one = seven_mm_one(:,2); %strain
F_seven_one = seven_mm_one(:,4); %force

load seven_mm_two.txt
S_seven_two = seven_mm_two(:,2); %strain
F_seven_two = seven_mm_two(:,4); %force

load seven_mm_three.txt
S_seven_three = seven_mm_three(:,2); %strain
F_seven_three = seven_mm_three(:,4); %force

%Average data for seven mm holes elements
S_seven_ava = (S_seven_one+S_seven_two+S_seven_three)/3; %average strain
F_seven_ava = (F_seven_one+F_seven_two+F_seven_three)/3; %average force
%% eight mm hole element
load eight_mm_one.txt
S_eight_one = eight_mm_one(:,2); %strain
F_eight_one = eight_mm_one(:,4); %force

load eight_mm_two.txt
S_eight_two = eight_mm_two(:,2); %strain
F_eight_two = eight_mm_two(:,4); %force

load eight_mm_three.txt
S_eight_three = eight_mm_three(:,2); %strain
F_eight_three = eight_mm_three(:,4); %force

%Average data for eight mm holes elements
S_eight_ava = (S_eight_one+S_eight_two+S_eight_three)/3; %average strain
F_eight_ava = (F_eight_one+F_eight_two+F_eight_three)/3; %average force
